...
const experiences: ICommand = {
    ...
    execute: async () => {
        const lines: Array<string> = [
            ...
            "  - Worked on {link}https://dojo.codes{/link} v1 as FrontEnd Developer. Built using {#FFCB6B}TypeScript{/#FFCB6B} and {#FFCB6B}React{/#FFCB6B}. Orness organized a dev event on this website with ~{#79DDD9}150{/#79DDD9} participants at the same time, and ~{#79DDD9}200{/#79DDD9} registered. Now working on {#e6d9f8}Dojo{/#e6d9f8}{#b1518e}.Codes{/#b1518e} v2.",
            "",
